...
class Answers {
    companion object {
        ...
        const val HELP_MESSAGE = "Привет! Этот бот предназначен для тех, кто не хочет пропустить скидку на ожидаемую игру. " +
                ...
                "присылать вам уведомления о всех изменениях цен на эту игру. Команда /searchNoExpansions " +
                "сделает то же самое, только отфильтрует из выдачи все дополнения. /list покажет вам список тех игр, " +
